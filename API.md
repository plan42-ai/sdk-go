...
See [FileMetadata](#1043-filemetadata) for more info on the response.
...
{
  "IsMalicious": *bool,
  "ModerationScanResults": *ModerationScanInfo,
}
```
...
| ModerationScanResults          | body     | *ModerationScanInfo | Optional. Sets the results of a moderations can. Cannot be modified once set.                                                                        |
