...
func (o *CreateTaskOptions) runWorkstream(ctx context.Context, s *SharedOptions) error {
	...
	var req p42.CreateWorkstreamTaskRequest
	err = readJsonFile(o.JSON, &req)
	if err != nil {
		return err
	}
...
func (o *UpdateTaskOptions) runWorkstream(ctx context.Context, s *SharedOptions) error {
	...
	var req p42.UpdateWorkstreamTaskRequest
	err = readJsonFile(o.JSON, &req)
	if err != nil {
		return err
	}
	...
	getReq := &p42.GetWorkstreamTaskRequest{
		TenantID:       o.TenantID,
...
func (o *DeleteTaskOptions) runNonWorkstream(ctx context.Context, s *SharedOptions) error {
	getReq := &p42.GetTaskRequest{TenantID: o.TenantID, TaskID: o.TaskID}
	...
	req := &p42.DeleteTaskRequest{TenantID: o.TenantID, TaskID: o.TaskID, Version: task.Version}
	req.FeatureFlags = getReq.FeatureFlags
	processDelegatedAuth(s, &req.DelegatedAuthInfo)
...
func (o *DeleteTaskOptions) runWorkstream(ctx context.Context, s *SharedOptions) error {
	getReq := &p42.GetWorkstreamTaskRequest{TenantID: o.TenantID, WorkstreamID: o.WorkstreamID, TaskID: o.TaskID}
	err := loadFeatureFlags(s, &getReq.FeatureFlags)
	if err != nil {
		return err
	}
	...
	req := &p42.DeleteWorkstreamTaskRequest{
		TenantID:     o.TenantID,
		WorkstreamID: o.WorkstreamID,
		TaskID:       o.TaskID,
...
type ListTasksOptions struct {
	...
	TaskNumber     *int   `help:"Optional. When set with --workstream-id, filters to the specified workstream task number." name:"task-number" short:"n" optional:""`
...
func (o *ListTasksOptions) Run(ctx context.Context, s *SharedOptions) error {
	if o.TaskNumber != nil && o.WorkstreamID == "" {
		return fmt.Errorf("--task-number requires --workstream-id")
	}
...
func (o *GetTaskOptions) runWorkstream(ctx context.Context, s *SharedOptions) error {
	req := &p42.GetWorkstreamTaskRequest{
		TenantID:       o.TenantID,
		WorkstreamID:   o.WorkstreamID,
		TaskID:         o.TaskID,
		IncludeDeleted: util.Pointer(o.IncludeDeleted),
