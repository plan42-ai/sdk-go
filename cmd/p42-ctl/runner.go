...
func (o *CreateRunnerOptions) Run(ctx context.Context, s *SharedOptions) error {
	...
	var req p42.CreateRunnerRequest
...
func (o *ListRunnerQueuesOptions) Run(ctx context.Context, s *SharedOptions) error {
	...
	req := &p42.ListRunnerQueuesRequest{
		TenantID:       o.TenantID,
		RunnerID:       o.RunnerID,
...
func (o *PingRunnerQueueOptions) Run(ctx context.Context, s *SharedOptions) error {
	req := &p42.PingRunnerQueueRequest{
		TenantID: o.TenantID,
		RunnerID: o.RunnerID,
		QueueID:  o.QueueID,
	}
...
func (o *DeleteRunnerQueueOptions) Run(ctx context.Context, s *SharedOptions) error {
	getReq := &p42.GetRunnerQueueRequest{
		TenantID: o.TenantID,
		RunnerID: o.RunnerID,
		QueueID:  o.QueueID,
	}
	...
	delReq := &p42.DeleteRunnerQueueRequest{
		TenantID: o.TenantID,
		RunnerID: o.RunnerID,
		QueueID:  o.QueueID,
...
func (o *DeleteRunnerOptions) Run(ctx context.Context, s *SharedOptions) error {
	...
	delReq := &p42.DeleteRunnerRequest{
		TenantID: o.TenantID,
		RunnerID: o.RunnerID,
...
func (o *UpdateRunnerOptions) Run(ctx context.Context, s *SharedOptions) error {
	...
	var req p42.UpdateRunnerRequest
	err = readJsonFile(o.JSON, &req)
	if err != nil {
		return err
	}
...
func (o *GenerateRunnerTokenOptions) Run(ctx context.Context, s *SharedOptions) error {
	...
	req := &p42.GenerateRunnerTokenRequest{
		TenantID: o.TenantID,
		RunnerID: o.RunnerID,
...
func (o *ListRunnerTokensOptions) Run(ctx context.Context, s *SharedOptions) error {
	...
	req := &p42.ListRunnerTokensRequest{
		TenantID:       o.TenantID,
		RunnerID:       o.RunnerID,
...
func (o *RevokeRunnerTokenOptions) Run(ctx context.Context, s *SharedOptions) error {
	getReq := &p42.GetRunnerTokenRequest{
		TenantID:       o.TenantID,
		RunnerID:       o.RunnerID,
		TokenID:        o.TokenID,
		IncludeDeleted: pointer(true),
	...
	req := &p42.RevokeRunnerTokenRequest{
		TenantID: o.TenantID,
		RunnerID: o.RunnerID,
		TokenID:  o.TokenID,
