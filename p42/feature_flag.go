...
func (c *Client) ListFeatureFlags(ctx context.Context, req *ListFeatureFlagsRequest) (
...
// nolint: dupl
func (c *Client) CreateFeatureFlagOverride(
	ctx context.Context,
	req *CreateFeatureFlagOverrideRequest,
) (*FeatureFlagOverride, error) {
	if req == nil {
		return nil, fmt.Errorf("req is nil")
	}
	if req.TenantID == "" {
...
// nolint: dupl
func (c *Client) GetFeatureFlagOverride(ctx context.Context, req *GetFeatureFlagOverrideRequest) (
	*FeatureFlagOverride,
	error,
) {
	if req == nil {
...
// nolint: dupl
func (c *Client) UpdateFeatureFlagOverride(
	ctx context.Context,
	req *UpdateFeatureFlagOverrideRequest,
) (*FeatureFlagOverride, error) {
	if req == nil {
		return nil, fmt.Errorf("req is nil")
	}
...
// nolint: dupl
func (c *Client) ListFeatureFlagOverrides(
	ctx context.Context,
	req *ListFeatureFlagOverridesRequest,
) (*ListFeatureFlagOverridesResponse, error) {
	if req == nil {
		return nil, fmt.Errorf("req is nil")
	}
	if req.TenantID == "" {
